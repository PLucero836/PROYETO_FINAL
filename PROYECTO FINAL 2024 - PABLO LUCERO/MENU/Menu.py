...
label_bienvenida = tk.Label(ventana, text="Selecciona un proyecto", font=("Arial", 16, "bold"), bg="#478ba0", fg="white")
label_bienvenida.pack(pady=20)

frame_boton = tk.Frame(ventana, bg="#478ba0")
frame_boton.pack(pady=20)

boton_algoritmos = tk.Button(frame_boton, text="Algoritmos", width=30, height=2, bg="#8de858", font=("Arial", 12, "bold"), command=abrir_algoritmos)
boton_algoritmos.pack(pady=5)

boton_matematica_discreta = tk.Button(frame_boton, text="Matemática Discreta", width=30, height=2, bg="#d4f121", font=("Arial", 12, "bold"), command=abrir_matematica_discreta)
boton_matematica_discreta.pack(pady=5)

boton_algebra_lineal = tk.Button(frame_boton, text="Álgebra Lineal", width=30, height=2, bg="#ffcc00", font=("Arial", 12, "bold"), command=abrir_algebra_lineal)
boton_algebra_lineal.pack(pady=5)

copyright_label = tk.Label(ventana, text="© 2024 PaluZero Code. Todos los derechos reservados", font=("Arial", 10), bg="#478ba0", fg="white")
