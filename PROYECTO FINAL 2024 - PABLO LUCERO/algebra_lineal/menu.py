...
class MenuPrincipal(tk.Frame):
    def __init__(self, padre):
        ...
        self.config(bg="#478ba0")
        self.widgets()

    def show_frames(self, container):
        top_level = tk.Toplevel(self)
        frame = container(top_level)
        frame.config(bg="#478ba0")
    ...
    def widgets(self):
        frame = tk.Frame(self, bg="#478ba0")
        frame.pack()
        frame.place(x=0, y=0, width=600, height=400)

        btn_multiplicacion = tk.Button(frame, bg="#f1a16d", fg="black", font="sans 16 bold", text="Multiplicación de Matrices", command=self.calculadora_multiplicacion)
        btn_multiplicacion.place(x=150, y=80, width=300, height=60)

        btn_inversa = tk.Button(frame, bg="#ffcc00", fg="black", font="sans 16 bold", text="Inversa de Matriz", command=self.calculadora_inversa)
        btn_inversa.place(x=150, y=160, width=300, height=60)

        btn_ecuaciones = tk.Button(frame, bg="#57b1c6", fg="black", font="sans 16 bold", text="Sistema de Ecuaciones", command=self.calculadora_ecuaciones)
        btn_ecuaciones.place(x=150, y=240, width=300, height=60)

        copyright_label = tk.Label(frame, text="© 2024 PaluZero Code. Todos los derechos reservados", font="sans 10 bold", bg="#478ba0", fg="white")
...
class MultiplicacionMatricesApp(tk.Frame):
    ...
    def widgets(self):
        frame1 = tk.Frame(self, bg="#478ba0")
        frame1.place(x=0, y=0, width=800, height=600)

        titulo = tk.Label(frame1, text="Calculadora de Multiplicación de Matrices", font=("Arial", 18, "bold"), bg="#478ba0", fg="white")
        titulo.place(x=200, y=20)

        self.btn_crear_matriz1 = tk.Button(frame1, bg="#8de858", fg="black", font=("Arial", 12, "bold"), text="Crear Matriz 1", command=self.crear_matriz1)
        self.btn_crear_matriz1.place(x=500, y=100, width=240, height=60)

        self.btn_crear_matriz2 = tk.Button(frame1, bg="#d4f121", fg="black", font=("Arial", 12, "bold"), text="Crear Matriz 2", command=self.crear_matriz2)
        self.btn_crear_matriz2.place(x=500, y=200, width=240, height=60)

        self.btn_multiplicar = tk.Button(frame1, bg="#ffcc00", fg="black", font=("Arial", 12, "bold"), text="Multiplicar Matrices", state=tk.DISABLED, command=self.multiplicar_matrices)
        ...
        copyright_label = tk.Label(frame1, text="© 2024 PaluZero Code. Todos los derechos reservados", font=("Arial", 10), bg="#478ba0", fg="white")
...
class InversaMatrizApp(tk.Frame):
    ...
    def widgets(self):
        ...
        titulo = tk.Label(frame1, text="Calculadora de Inversa de Matriz", font=("Arial", 18, "bold"), bg="#478ba0", fg="white")
        titulo.place(x=250, y=20)

        self.btn_crear_matriz = tk.Button(frame1, bg="#8de858", fg="black", font=("Arial", 12, "bold"), text="Crear Matriz", command=self.crear_matriz)
        self.btn_crear_matriz.place(x=500, y=100, width=240, height=60)

        self.btn_inversa = tk.Button(frame1, bg="#ffcc00", fg="black", font=("Arial", 12, "bold"), text="Calcular Inversa", state=tk.DISABLED, command=self.calcular_inversa)
...
class SistemaEcuacionesApp(tk.Frame):
    ...
    def widgets(self):
        ...
        titulo = tk.Label(frame1, text="Solución de Sistema de Ecuaciones", font=("Arial", 18, "bold"), bg="#478ba0", fg="white")
        titulo.place(x=250, y=20)

        self.btn_crear_ecuaciones = tk.Button(frame1, bg="#8de858", fg="black", font=("Arial", 12, "bold"), text="Crear Sistema de Ecuaciones", command=self.crear_ecuaciones)
        self.btn_crear_ecuaciones.place(x=500, y=100, width=240, height=60)

        self.btn_resolver_ecuaciones = tk.Button(frame1, bg="#ffcc00", fg="black", font=("Arial", 12, "bold"), text="Resolver Sistema", state=tk.DISABLED, command=self.resolver_ecuaciones)
