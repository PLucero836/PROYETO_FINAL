...
class MatrixCalculatorApp(tk.Frame):
    ...
    def widgets(self):
        ...
        titulo = tk.Label(frame1, text="Calculadora de Sistemas de Ecuaciones", font=("Arial", 18, "bold"), bg="#478ba0", fg="white")
        titulo.place(x=250, y=20)

        self.btn_crear_matriz = tk.Button(frame1, bg="#8de858", fg="black", font=("Arial", 12, "bold"), text="Crear Matriz y Vector", command=self.crear_matriz)
        self.btn_crear_matriz.place(x=500, y=100, width=240, height=60)

        self.btn_gauss_jordan = tk.Button(frame1, bg="#ffcc00", fg="black", font=("Arial", 12, "bold"), text="Resolver por Gauss-Jordan", state=tk.DISABLED, command=self.resolver_gauss_jordan)
        self.btn_gauss_jordan.place(x=500, y=200, width=240, height=60)

        self.btn_cramer = tk.Button(frame1, bg="#ffcc00", fg="black", font=("Arial", 12, "bold"), text="Resolver por Regla de Cramer", state=tk.DISABLED, command=self.resolver_cramer)
